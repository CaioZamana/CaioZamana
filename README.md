...
[![My Skills](https://skillicons.dev/icons?i=git,java,gradle,maven,kotlin,mysql,docker,html,css,js&theme=light)](https://github.com/caiobello/)<br>
Git, Java, Gradle, Maven Kotlin, MySql, Docker, Html, CSS and JavaScrpit.
 <br>
